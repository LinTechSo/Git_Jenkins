...
Vagrant.configure("2") do |config|
  config.vm.define "jenkins" do |jenkins|
    ...
    jenkins.vm.network :privarte_network, ip: "192.168.122.12"
	...
	ansible.playbook = "jenkins/jenkinsOverTomcat.ym"
  ...
  config.vm.define "git" do |git|
    ...
    git.vm.network :private_network, ip:"192.168.122.13"
	...
	ansible.invetory_path = "inventory/hosts"
    end
  end
end
